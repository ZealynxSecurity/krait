...
**Read `~/.claude/skills/krait/detector/heuristics-core.md`** — 43 trigger-based checks, each
extracted from a real missed finding or a real exploit. **Read
`~/.claude/skills/krait/detector/heuristics-extended.md`** — 58 further vectors from
open-source community sources.
...
Per-lens mandatory heuristics are listed under each lens in Pass 2 above.
